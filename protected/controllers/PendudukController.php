...
class PendudukController extends MyAdminController
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Penduduk']))
		{
			$model->attributes=$_POST['Penduduk'];
                        ...
                        $this->notice($is_success,'Penduduk','create');
			if($is_success){
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Penduduk']))
		{
			$model->attributes=$_POST['Penduduk'];
                        $is_success=$model->save();
                        $this->notice($is_success,'Penduduk','update');
			if($is_success)
				$this->redirect(array('view','id'=>$model->id));
		}
                if($_GET['ajax'])
	...
	public function actionDelete($id)
	{
                ...
                $this->notice($is_success,'Penduduk','delete');
		// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
                		$this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : Yii::app()->createUrl('766e0e5f/penduduk'));
	}
