...
<div class="span5" style="text-align: left">
    <div class="cms-admin-buttons">
        ...
        <?php $this->widget('bootstrap.widgets.TbButton',array(
                'icon'=>'plus white',
                'label'=>'Tambah Travel Seat',
                'url'=>Yii::app()->createUrl('pageadmin/travelSeat/create'),
                'type'=>'primary',
...
<?php $this->widget('MyCGridView', array(
	'id'=>'travel-seat-grid',
	'dataProvider'=>$model->search(Yii::app()->request->getQuery('TravelSeat',array())),
	//'filter'=>$model,
	'columns'=>array(
            array(
                    'header' => 'No',
		...
		array(
                    ...
                    'buttons'=>array(
                        'view'=>array(
                            ...
                            'url' => 'Yii::app()->createUrl("pageadmin/travelSeat/view/", array("id"=>$data["id"]))',
                        ),
                        'update'=>array(
                            'options'=>array('target'=>'ajax-modal','title'=>'Edit'),
                            'url' => 'Yii::app()->createUrl("pageadmin/travelSeat/update/", array("id"=>$data["id"]))',
                        ),
                        'delete'=>array(
                            'url' => 'Yii::app()->createUrl("pageadmin/travelSeat/delete/", array("id"=>$data["id"]))',
                        ),
                    ),
                    'header'=>'Action'
		),
