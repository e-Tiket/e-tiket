...
<?php $this->beginWidget('bootstrap.widgets.TbModal', array('id'=>'searchModal')); ?><div class="modal-header">
    ...
    <h3>Advanced Search Travel Seat</h3>
</div>
...
<fieldset>
	...
	<div class="control-group">
		...
		<div class="controls"><?php echo $form->textField($model,'keterangan',array('size'=>30,'maxlength'=>30,)); ?>
</div>
	</div>

	<div class="control-group">
		<?php echo $form->label($model,'jumlah',array('class'=>'control-label')); ?>
		<div class="controls"><?php echo $form->textField($model,'jumlah',array()); ?>
</div>
	</div>

	<div class="control-group">
		<?php echo $form->label($model,'gambar',array('class'=>'control-label')); ?>
		<div class="controls"><?php echo $form->textField($model,'gambar',array('size'=>60,'maxlength'=>150,)); ?>
</div>
	</div>
