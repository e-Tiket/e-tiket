...
<div class="modal-header">
    ...
    <h3><?php echo $model->isNewRecord ? 'Tambah' : 'Edit'?> Admin </h3>
</div>
<div class="modal-body">
	...
	<div class="control-group">
		<?php echo $form->labelEx($model,'admin_type',array('class'=>'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model,'admin_type',array('size'=>32,'maxlength'=>32,)); ?>
                    <?php echo $form->error($model,'admin_type'); ?>
                </div>    
	</div>
