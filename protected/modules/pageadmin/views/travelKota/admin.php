...
<div class="span5" style="text-align: left">
    <div class="cms-admin-buttons">
        ...
        <?php $this->widget('bootstrap.widgets.TbButton',array(
                'icon'=>'plus white',
                'label'=>'Tambah Travel Kota',
                'url'=>Yii::app()->createUrl('pageadmin/travelKota/create'),
                'type'=>'primary',
...
<?php $this->widget('MyCGridView', array(
	'id'=>'travel-kota-grid',
	'dataProvider'=>$model->search(Yii::app()->request->getQuery('TravelKota',array())),
	//'filter'=>$model,
	'columns'=>array(
            array(
                    'header' => 'No',
		...
		array(
                    ...
                    'buttons'=>array(
                        'view'=>array(
                            ...
                            'url' => 'Yii::app()->createUrl("pageadmin/travelKota/view/", array("id"=>$data["id"]))',
                        ),
                        'update'=>array(
                            'options'=>array('target'=>'ajax-modal','title'=>'Edit'),
                            'url' => 'Yii::app()->createUrl("pageadmin/travelKota/update/", array("id"=>$data["id"]))',
                        ),
                        'delete'=>array(
                            'url' => 'Yii::app()->createUrl("pageadmin/travelKota/delete/", array("id"=>$data["id"]))',
                        ),
                    ),
                    'header'=>'Action'
		),
