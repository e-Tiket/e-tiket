...
class KapalController extends MyAdminController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Kapal']))
		{
			$model->attributes=$_POST['Kapal'];
                        ...
                        $this->notice($is_success,'Kapal','create');
			if($is_success){
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Kapal']))
		{
			$model->attributes=$_POST['Kapal'];
                        $is_success=$model->save();
                        $this->notice($is_success,'Kapal','update');
			if($is_success)
				$this->redirect(array('view','id'=>$model->id));
		}
                if($_GET['ajax'])
	...
	public function actionDelete($id)
	{
                ...
                $this->notice($is_success,'Kapal','delete');
		// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
                		$this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : Yii::app()->createUrl('pageadmin/kapal'));
	}
