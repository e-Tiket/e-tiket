<form action="<?php echo Yii::app()->createUrl('site/index#tab2')?>" name="travel-form">
    ...
    <?php echo CHtml::dropDownList('asal', Yii::app()->request->getQuery('asal'), Travel::model()->destinationDropdownModel(array('- Pilih Asal Kota -')), array('class'=>'chosen span12'))?><div class="clear"></div>
    Ke<div class="clear"></div>
    <?php echo CHtml::dropDownList('tujuan', Yii::app()->request->getQuery('tujuan'), Travel::model()->destinationDropdownModel(array('- Pilih Kota Tujuan -')), array('class'=>'chosen span10'))?><div class="clear"></div>
