...
<div class="span5" style="text-align: left">
    <div class="cms-admin-buttons">
        ...
        <?php $this->widget('bootstrap.widgets.TbButton',array(
                ...
                'url'=>Yii::app()->createUrl('766e0e5f/penduduk/create'),
                'type'=>'primary',
...
<?php $this->widget('MyCGridView', array(
	'id'=>'penduduk-grid',
	'dataProvider'=>$model->search(Yii::app()->request->getQuery('Penduduk',array())),
	//'filter'=>$model,
	'columns'=>array(
            array(
                    'header' => 'No',
		...
		array(
                    ...
                    'buttons'=>array(
                        'view'=>array(
                            ...
                            'url' => 'Yii::app()->createUrl("766e0e5f/penduduk/view/", array("id"=>$data["id"]))',
                        ),
                        'update'=>array(
                            'options'=>array('target'=>'ajax-modal','title'=>'Edit'),
                            'url' => 'Yii::app()->createUrl("766e0e5f/penduduk/update/", array("id"=>$data["id"]))',
                        ),
                        'delete'=>array(
                            'url' => 'Yii::app()->createUrl("766e0e5f/penduduk/delete/", array("id"=>$data["id"]))',
                        ),
                    ),
                    'header'=>'Action'
		),
