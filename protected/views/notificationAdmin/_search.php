...
<?php $this->beginWidget('bootstrap.widgets.TbModal', array('id'=>'searchModal')); ?><div class="modal-header">
    ...
    <h3>Advanced Search Notification Admin</h3>
</div>
...
<fieldset>
	...
	<div class="control-group">
		...
		<div class="controls"><?php echo $form->textField($model,'url',array('size'=>60,'maxlength'=>255,)); ?>
</div>
	</div>
	...
	<div class="control-group">
		<?php echo $form->label($model,'read_by',array('class'=>'control-label')); ?>
		<div class="controls"><?php echo $form->textField($model,'read_by',array()); ?>
</div>
	</div>
