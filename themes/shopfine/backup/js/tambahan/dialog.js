...
$(function dialogClick(){
  ...
  $('a[target=modal],button[target=modal]').click(function(){
    ...
    $('body').live('a[target=ajax-modal],button[target=ajax-modal]','click',function(event){
        alert('haloo');
        event.preventDefault();
        var url = $(this).attr('href');
        ajaxModal(url,$(this));
...
function noticeSuccess(pesan){
    ...
    $('#alertMessage').append(''
    +'<div class="alert alert-success" id="pesan">'+pesan+'</div>'
    +'');
//    $('#alertMessage').show();
    $('#alertMessage').fadeIn().delay(5000).fadeOut(function(){
      $('#alertMessage').html(' ');
    });
}
...
//    $('#alertMessage').html(' ');  
    ...
    $('#alertMessage').html(''
    +'<div class="alert" id="pesan">'+pesan+'</div>'
    +'');
  }
  function noticeFailed(pesan){
    ...
    $('#alertMessage').append(''
    +'<div class="alert alert-error" id="pesan">'+pesan+'</div>'
    +'');
//    $('#alertMessage').show();
    $('#alertMessage').fadeIn().delay(5000).fadeOut(function(){
      $('#alertMessage').html(' ');
